...
public class OutputView {
    ...
    private static final String INPUT_ADDITIONAL_CARD_ERROR_MESSAGE = "[ERROR] y 혹은 n으로 입력해주십시오.";
    ...
    public static void printInputAdditionalCardErrorMessage() {
        System.out.println(INPUT_ADDITIONAL_CARD_ERROR_MESSAGE);
    }
